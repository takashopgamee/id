...
function order_gas() {
    ...
    // Lanjutkan dengan logika pesanan
        ...
        var message = "*_Detail Pesanan Saya :_*\n" +
            ...
            "_Produk_ : " + product + "\n" +
            "_Harga_ : " + price + "\n" +
            "_Metode Pembayaran_ : " + method + "\n" +
            "_No. WhatsApp_ : " + wa + "\n" +
            "_Catatan Penjoki_ : " + cat;

        // Membuat URL WhatsApp dengan nomor tujuan dan pesan yang telah dibuat
        var whatsappUrl = "https://api.whatsapp.com/send?phone=6289654791642&text=*Halo%20Admin,%20Saya%20Mau%20Joki Gendong%20Mlbb*.%0A%0A" + encodeURIComponent(message);
